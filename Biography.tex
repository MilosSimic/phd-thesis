...
\noindent
Trough colaboration with people from different research areas, this theis gain forml description and formal model that is important leverage, to describe and validate such complicated system that is described in this thesis. In 2021, the work published in the \emph{IEEE Access} journal (paper (cf. journal paper~\ref{accessSimic}), is presented to the eminent professors from the \emph{Imperial College} from London.
%
%