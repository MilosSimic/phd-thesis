...
To achieve such elasticity, we must abstract the infrastructure to level of software, creating "infrastructure programming”~\cite{Fitzgerald}, allowing micro cloud infrastructure to be managed in a similar way as the software is.
