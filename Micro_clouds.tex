...
%
Observability is an importatnt part of any real-world computing system (cf. \pageref{sec:log_aggregation}). It is important part of any platform that strive to be offered as a service to large groups of different users. 
