...
One question that could that requre an answer is, what if some cloud provider offering $\upmu$C functionality, or running our master process, goes down, should the rest of the $\upmu$Cs go to \textit{read-only} mode and only accept \textbf{read} requests?
