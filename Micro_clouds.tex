...
%
%
\subsection{Deployment in micro clouds}
%
...
\noindent
On the other side of the spectrum, the users should be able to choose the \emph{recreation} strategy as well. This strategy will causes higher downtime, but it will do updates quickly. 
