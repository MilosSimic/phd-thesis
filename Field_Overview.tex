...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{images/Figure21.png}
	\end{center}
	\vspace{-0.6cm}
...
Figure~\ref{fig:fig22} shows an example diagram for CQRS pattern.

\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{images/Figure22.png}
	\end{center}
	\vspace{-0.6cm}
