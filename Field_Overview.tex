...
This pattern enables tracking of resources using two simple states: 
...
\noindent
The reconciler pattern runs a \textbf{reconciliation loop} that ensures that the \emph{current state} remains the same as the \emph{expected state}. 
