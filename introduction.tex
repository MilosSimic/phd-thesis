...
\begin{enumerate} [start=1,label={(\bfseries \arabic*)}]
	...
	It is important to notice that even a 99\% available system gives almost four days of downtime a year, which is unacceptable for services like Facebook, google, AWS. And when service is down, companies are loosing customers.
...
\begin{equation}
	\forall x, x * x = x
\end{equation}
\myequations{Idempotency formula}
