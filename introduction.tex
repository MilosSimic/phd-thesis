...
\noindent
In modern complex software development, SREs should keep things running smoothly, while DevOps principles should be used to improve processes. So it is not either/or, but it seems that combination of approaches may provide best results. However, in some smaller organizations these roles can overlap.
%
%
